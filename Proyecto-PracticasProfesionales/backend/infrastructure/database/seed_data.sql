...
INSERT INTO empresa (
    ...
    (1, 'TechNova Solutions', 'TNO260101AB1', 'Desarrollo de software', 'Av. Universidad 120, Ciudad de Mexico', '5550102030', 'contacto@technova.local', 'Activa'),
    (2, 'Industrias Orion', 'IOR260101CD2', 'Manufactura', 'Parque Industrial Norte 45, Ciudad de Mexico', '5550102040', 'rh@orion.local', 'Activa')
ON DUPLICATE KEY UPDATE
...
INSERT INTO convenio (
    ...
    (1, 1, '2026-01-01', '2026-12-31', 'uploads/documentos/convenio-technova.pdf', 'Vigente'),
    (2, 2, '2026-01-01', '2026-12-31', 'uploads/documentos/convenio-orion.pdf', 'Vigente')
ON DUPLICATE KEY UPDATE
    id_empresa = VALUES(id_empresa),
    fecha_inicio = VALUES(fecha_inicio),
    fecha_fin = VALUES(fecha_fin),
...
INSERT INTO vacante (
    ...
    (1, 1, 1, 'Desarrollador Backend Jr.', 'Apoyo en desarrollo de APIs y automatizacion de procesos internos.', 'Hibrida', 'Lunes a viernes 09:00-14:00', 3, 2, 'Activa'),
    (2, 2, 2, 'Analista de Procesos', 'Documentacion y mejora de procesos administrativos.', 'Presencial', 'Lunes a viernes 08:00-13:00', 2, 2, 'Activa')
ON DUPLICATE KEY UPDATE
    id_empresa = VALUES(id_empresa),
    id_carrera = VALUES(id_carrera),
