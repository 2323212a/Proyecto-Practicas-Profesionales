...
from interfaces.api.schemas.tipo_documento import TipoDocumentoCreate, TipoDocumentoResponse
from interfaces.api.service_factory import TipoDocumentoService

from interfaces.api.schemas.tipo_documento import (
    TipoDocumentoCreate,
...
def obtener_tipo_documento(
    ...
    tipo = TipoDocumentoService(db).obtener_por_id(id_tipo_documento)
