...
export function ValidacionMaterias() {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">
          Sube el archivo requerido para que coordinación pueda validar tu proceso.
        </p>
      </div>
      ...
      >
        ...
        <div className="flex-1">
          ...
          >
            {estado === "validado"
              ? "Tu archivo fue revisado y aprobado por coordinación."
              : estado === "pendiente"
              ? "Tu archivo fue enviado y está en revisión."
              : "Debes subir el archivo solicitado para continuar con el proceso."}
          </div>
        </div>
