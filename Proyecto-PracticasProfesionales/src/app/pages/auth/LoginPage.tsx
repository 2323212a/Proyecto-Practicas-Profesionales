            ...
            <div className="px-8 py-8">
              {!showRecovery ? (
                <div className="space-y-5">
                  ...
                  <button
                    onClick={handleLogin}
                    className="w-full py-3.5 bg-[#0d2b5e] text-white rounded-xl font-bold hover:bg-[#1565c0] transition-colors flex items-center justify-center gap-2 shadow-lg"
                  >
                  ...
                  <div className="border-t border-gray-100 pt-4 text-center">
                    <span className="text-sm text-gray-500">
                      ¿Problemas de acceso? Contacta a tu
                      coordinador.
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                      Ingresa tu correo institucional para
                      recibir un enlace de recuperación.
                    </p>
                  </div>
                  {!recoverySent ? (
                    <>
