  ...
  const tarjetas = [
    {
      ...
      value: resumen?.solicitudes_nuevas ?? resumen?.empresas_pendientes ?? 0,
      icon: Building2,
      color: "bg-orange-500",
    },
    {
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
        ...
        <div className="grid md:grid-cols-5 gap-4">
          {[
            ...
            {
              title: "Expedientes",
              subtitle: "Documentos empresariales",
              icon: FileText,
            ...
            },
            {
              ...
              subtitle: "Pre-padron y publicadas",
              icon: ClipboardList,
