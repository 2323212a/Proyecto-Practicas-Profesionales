...
export function RegisterPage() {
  ...
  const set = (campo: keyof RegisterForm) => (event: ChangeEvent<HTMLInputElement>) => {
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="px-8 py-8 space-y-5">
              {([
                ...
                { label: "Matrícula", key: "matricula", type: "text", placeholder: "Ej. 215A10234" },
                { label: "Correo Institucional", key: "correo", type: "email", placeholder: "usuario@unach.mx" },
                { label: "Teléfono", key: "telefono", type: "tel", placeholder: "Ej. 961 123 4567" },
              ] satisfies Array<{
                label: string;
                key: keyof Pick<RegisterForm, "nombre" | "matricula" | "correo" | "telefono">;
                type: string;
                placeholder: string;
              }>).map((field) => (
                <div key={field.key}>
