...
router = APIRouter(
    ...
    dependencies=[Depends(requerir_roles(["Coordinador de Unidades Receptoras"]))],
)
...
def _crear_plantilla() -> bytes:
    ...
    reglas = [
        ...
        "No repetir RFC ni correos institucionales.", "El estatus Aceptado se guarda como empresa Activa y solicitud Aceptada.",
    ...
    for fila in meta["filas"]:
        ...
        try:
            with db.begin_nested():
                ...
                estado_empresa = "Activa" if datos[COLUMNAS[21]] == "Aceptado" else datos[COLUMNAS[21]]
                estado_solicitud = "Aceptada" if datos[COLUMNAS[21]] == "Aceptado" else "Recibida"
